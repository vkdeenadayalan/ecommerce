...
class category(models.Model):
    ...
    cat_slug=AutoSlugField(populate_from='name',unique=True,max_length=250,null=True,default=None)
...
class Product(models.Model):   
    ...
    pro_slug=AutoSlugField(populate_from='name',unique=True,max_length=250,null=True,default=None)
